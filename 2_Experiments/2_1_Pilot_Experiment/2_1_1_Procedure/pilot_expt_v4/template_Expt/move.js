...
var example = {
  ...
  aperture_center_y: [220, 220],
  aperture_center_x: [400, 980],
...
var match_RDK = {
  ...
  on_start: function() {
    ...
    // 替换第二个元素的 label 属性
    conditions_match_selfLeft[1].label = `${labelVar}`;
    // 替换第四个元素的 label 属性
    conditions_match_selfLeft[3].label = `${labelVar}`;
