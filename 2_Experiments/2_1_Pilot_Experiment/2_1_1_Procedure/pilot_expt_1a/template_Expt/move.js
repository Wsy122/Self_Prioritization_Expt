...
var conditions_match_selfLeft = [
  ...
  { coherent_direction: 0, label: "自己", correct_choice: ["j"], correct_responce: "j", match: "no", association: "other"},
  { coherent_direction: 180, label: "生人", correct_choice: ["j"], correct_responce: "j", match: "no", association: "self"}
];
...
var conditions_match_selfRight = [
  ...
  { coherent_direction: 180, label: "自己", correct_choice: ["j"], correct_responce: "j", match: "no", association: "other"},
  { coherent_direction: 0, label: "生人", correct_choice: ["j"], correct_responce: "j", match: "no", association: "self"}
];
